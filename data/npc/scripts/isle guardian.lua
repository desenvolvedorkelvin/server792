...
local voices = { {text = 'Passage to Carlin!'} }
...
addTravelKeyword('tibia', 80, Position(32204, 31756, 6))
addTravelKeyword('carlin', 80, Position(32204, 31756, 6))
addTravelKeyword('back', 80, Position(32204, 31756, 6))
addTravelKeyword('main', 80, Position(32204, 31756, 6))
