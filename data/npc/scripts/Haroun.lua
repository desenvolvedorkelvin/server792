...
shopModule:addBuyableItem({'sword ring'}, 2207, 1000, 'sword ring') 
shopModule:addBuyableItem({'club ring'}, 2209, 1000, 'club ring') 
shopModule:addBuyableItem({'axe ring'}, 2208, 1000, 'axe ring') 
shopModule:addBuyableItem({'power ring'}, 2166, 1000, 'power ring') 
...
shopModule:addBuyableItem({'bronze amulet'}, 2172, 1000, 'bronze amulet') 
...
keywordHandler:addKeyword({'sell'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Why would I need that rubbish? Just fooling you... I buy Sword ring, Club ring, Axe ring, Power ring and Stealth rings. Stone skin amulet, Elven amulet, Bronze amulet and Garlic necklace. Magic light wand, Wand of Vortex, Wand of Dragonbreath, Wand of Plague, Wand of Cosmic Energy and Wand of Inferno. I also buy Orbs, Mind stones and Life Crystals.'}) 
