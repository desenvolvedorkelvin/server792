...
local voices = { {text = 'Passages to Nibelor and Svargrond!'} }
...
addTravelKeyword('svargrond', 160, Position(32302, 31083, 7))
addTravelKeyword('nibelor', 180, Position(32328, 31047, 7))
