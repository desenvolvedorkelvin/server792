...
node1:addChildKeyword({'yes'}, StdModule.promotePlayer, {npcHandler = npcHandler, premium = false, cost = 20000, level = 20, text = 'Congratulations! You are now promoted. Visit the sage Eremo for new spells.'})
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "uniform") then
		local player = Player(cid)
		if player:getStorageValue(2010) == 5 then
