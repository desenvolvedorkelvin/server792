...
addTravelKeyword('frost island', 160, Position(32403, 31536, 7))
addTravelKeyword('tibia', 20, Position(32234, 31678, 7))   
addTravelKeyword('back', 20, Position(32234, 31678, 7))
addTravelKeyword('carlin', 20, Position(32234, 31678, 7))
...
function greetCallback(cid)
	...
	if player:getSex() == PLAYERSEX_MALE then
		npcHandler:setMessage(MESSAGE_GREET, "Ahoi, young man ".. player:getName() .." and welcome to the Nordic Tibia Ferries. You go travel to Senja, Folda, Vega or Frost Island?")
	else
		npcHandler:setMessage(MESSAGE_GREET, "Ahoi, young lady ".. player:getName() .." and welcome to the Nordic Tibia Ferries. You go travel to Senja, Folda, Vega or Frost Island?")
	end	
	return true
end
