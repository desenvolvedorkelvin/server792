...
class SchedulerTask : public Task
{
	...
	protected:
		...
		friend SchedulerTask* createNewSchedulerTask(uint32_t delay, std::function<void (void)> f, const std::string& description, const std::string& extraDescription);
};

inline SchedulerTask* createNewSchedulerTask(uint32_t delay, std::function<void (void)> f, const std::string& description, const std::string& extraDescription)
{
