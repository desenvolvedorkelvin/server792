...
local msg = msg:lower()
------------------------------------------------------------------
if npcHandler.topic[cid] == 0 and msg == 'task' then
...
elseif npcHandler.topic[cid] == 0 and msg == 'daily errorss' then
...
elseif msg == 'receive' then
	if npcHandler.topic[cid] == 0 then
		npcHandler:say("What kind of task did you finish, {task}?", cid)
...
elseif msg == 'abandon' then
	if npcHandler.topic[cid] == 0 then
		npcHandler:say("Aff, what kind of task do you want to quit, {task} or {daily}?", cid)
...
elseif msg == "task list" then
	local text = "----**| -> task Tasks <- |**----\n\n"
		...
		npcHandler:say("Here is the list of task tasks.", cid)
elseif msg == "daily taskerror list" then
