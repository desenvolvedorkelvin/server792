...
addTravelKeyword('camp', 'the south of Hrodmir where the camps of the barbarians are located. kay?', Position(32153, 31375, 7)) 
addTravelKeyword('svargrond', 'the south of Hrodmir where the camps of the barbarians are located. kay?', Position(32255, 31196, 7)) 
-- Kick
